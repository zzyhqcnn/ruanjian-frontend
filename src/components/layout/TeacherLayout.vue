    ...
    <header class="navbar">
      <div class="navbar-container">
        ...
        <nav class="nav-links" ref="navLinksRef">
          <router-link to="/teacher" class="nav-link" :class="{ active: isActive('/teacher') }"
            >首页</router-link
          >
          <router-link
            to="/teacher/prepare"
            class="nav-link"
            :class="{ active: isActive('/teacher/prepare') }"
            >智能备课</router-link
          >
          <router-link
            to="/teacher/analysis"
          ...
          <router-link
            ...
            class="nav-link"
            :class="{ active: isActive('/teacher/assignment') }"
            >作业布置</router-link
          >
          <router-link
            to="/teacher/ai-chat"
            class="nav-link"
            :class="{ active: isActive('/teacher/ai-chat') }"
            >智能对话</router-link
          >
          <!-- 添加滑动指示器 -->
